...
<div class="navigation-wrap bg-light start-header start-style">
  <div class="container">
      ...
      <div class="col-12">
        ...
        <div class="page_header">
            ...
            <select class="opt" name="example">
                        ...
                        <button class="btcn" type="btn">Cập nhật</button>
                </div><br><br>
            ...
            <table style="width:100%">
                    ...
                    <tr>
                        <td>01</td>
                        <td>Nhà trọ Bảy Bảnh</td>
                        <td>Cho thuê phòng</td>
                        <td><img class="imgp" src="ha_phong/phong-tro-co-gac-1.jpg" width="150px"></td>
                        <td>278/32/18 - đường Tầm Vu, Hưng Lợi, Ninh Kiều, Cần Thơ</td>
                        <td>1200000</td>
                        <td>Phòng có gác</td>
                        <td>Phòng có gác, rộng rãi thoáng máy, gần Đại Học Cần Thơ, gần Chợ Xuân Khánh</td>
                        <td>1</td>
                        <td><button type="" id="btn3" class="btn">Duyệt</button>
                    ...
                    <tr>
                        <td>02</td>
                        <td>Nhà trọ Nắng Xanh</td>
                        <td>Cho thuê phòng tháng 4</td>
                        <td><img class="imgp" src="ha_phong/phong-tro-co-gac-2.jpg" width="150px"></td>
                        <td>2QC8+36W Nhà trọ Nắng Xanh, Hưng Lợi, Ninh Kiều, Cần Thơ</td>
                        <td>1500000</td>
                        <td>Phòng có máy lạnh</td>
                        <td>Phòng lớn vị trí thuận lợi</td>
                        <td>2</td>
                        <td><button type=""  id="btn4" class="btn">Duyệt</button>
                                        <button type="" id="btn5" class="btn">Xóa</button>
                                        <script language="javascript">
    ...
    <br>
    <button class="btc" type="btn">Trở về</button>
