...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="image/home-v1.png"/>
         <link href="css/duyetbai.css" rel="stylesheet" type="text/css" media="all"/>
         ...
         <link href="css/caidatmoi.css" rel="stylesheet" type="text/css" media="all"/>
        ...
        <script src="js/duyetbai.js" type="text/javascript"></script>
...
<!-- test -->
  <div class="mt-3 container">
    <ol class="mx-3 md:mx-0 s1vf7tl0">
  <li itemprop="itemListElement" itemscope="" itemtype="">
  <a href="https://www.chotot.com" itemprop="item">
  <span itemprop="name">BingHouse</span></a>
  <svg xmlns="" viewBox="0 0 13 20" data-type="monochrome" width="1em" height="1em" fill="none" class="separator">
  <path fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" d="M2 2l8 7.9L2 18"></path>
</svg>
  <meta itemprop="position" content="1">
  </li>
  <li itemprop="itemListElement" itemscope="" itemtype="">
    <a href="" class="text-blue-500 inline-flex max-w-[150px] md:max-w-none [&amp;>span]:truncate" itemprop="item">
    <span itemprop="name">Trang cá nhân của Tên chưa cung cấp</span></a>
  ...
  <br><br><br><br><meta itemprop="position" content="3"></li></ol>
  ...
  <label for="">Họ và tên chủ trọ</label>
  <div class="ib7fnnz">
    <input class="i1qhutuv i1ahsojf hasValue required" type="text" inputmode="text" name="full_name" value="Nhập họ tên " fdprocessedid="6970r">
  </div>
  <p class="p4nrsyj"></p>
  </div>
  <div class="flex gap-3">
  <div class="c4zo2ss" style="--c4zo2ss-0:100%">
  <div class="wrapper ib7fnnz">  
    <label class="label" for="">Giới tính</label>

  <select class="select i1qhutuv isDropdown" name="gender" fdprocessedid="su0htr">
  <option disabled="" value="" selected="">Giới tính</option>
  <option value="f">Nữ</option>
  <option value="m">Nam</option>
  <option value="u">Giới tính khác</option>
  </select>
  <svg data-type="monochrome" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="none" class="arrow"></svg>
</div>
  <div class=" [&amp;>div>div>input]:pointer-events-none w-full">
  <div class="c4zo2ss" style="--c4zo2ss-0:100%">
  <label for="">Số điện thoại chủ trọ</label>
  <div class="disabled ib7fnnz">
  <input class="i1qhutuv i1ahsojf hasValue required"  type="text" inputmode="text" name="phone" value="Nhập số điện thoại" disabled="" fdprocessedid="zhowje">
...
<p class="p4nrsyj"></p>
  ...
  <label class="label" for="">Địa chỉ</label>  
    ...
    <div class="wrapper ib7fnnz">
      <select class="select i1qhutuv isDropdown" fdprocessedid="ripo2jn">
  <option disabled="" value="" selected="">Huyện/Quận</option>
  <option value="default">Ninh Kiều</option>
  <option value="default">Cái Răng</option>
  <option value="default">Bình Thủy</option>
  <option value="default">Phong Điền</option>
  ...
  <option disabled="" value="" selected="">Xã/Phường</option>
  <option value="default">An Thới</option>
  <option value="default">An Cư</option>
  <option value="default">An Nghiệp</option>
  <option value="default">An Khánh</option>
  <option value="default">An Bình</option>
  <option value="default">Cái Khế</option>
  <option value="default">Hưng Lợi</option>
  <option value="default">An Hòa</option>
  
  <div class="[&amp;>div>svg]:-rotate-90 [&amp;>div>select]:pr-7 [&amp;>div>select]:text-ellipsis [&amp;>div>select]:overflow-hidden c4zo2ss" style="--c4zo2ss-0:100%">
  <div class="wrapper ib7fnnz">
  <select class="select i1qhutuv isDropdown" fdprocessedid="ripo2jn">
<option disabled="" value="" selected="">Tỉnh/Thành</option>
  <option value="default">Cần Thơ</option>
</select>  
  </div>
  ...
  <div class="focus-capture">
  </div>
  <label for="">Giới thiệu</label>
  <textarea class="s18pqg82" inputmode="text" rows="4" cols="140" name="description" placeholder="Viết vài dòng giới thiệu về gian hàng của bạn..."></textarea>
  ...
  <h2 class="text-lg font-be ">Thông tin khu trọ</h2>
  <label for="">Tên khu trọ:</label>
  <input class="i1qhutuv i1ahsojf" type="text" inputmode="text" name="email" value="" fdprocessedid="q662kc">
  <label for="">Số nhà:</label>
  <input class="i1qhutuv i1ahsojf" type="text" inputmode="text" name="email" value="" fdprocessedid="q662kc">
    </div>
<button class="btnluu" class="ab">Lưu thay đổi</button>
</div>
</div>
</div>
