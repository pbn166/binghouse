   ...
   <div class="l1tlqmyy">
      <ol class="mx-3 md:mx-0 s1vf7tl0" style="padding-bottom:20px" itemscope=""
         ...
         <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem"><a href="setting.php"
               class="text-blue-500 inline-flex max-w-[150px] md:max-w-none [&amp;>span]:truncate" itemprop="item"><span
                  itemprop="name">Trang cá nhân của
                  <?php echo $_SESSION['TENDANGNHAP']; ?>
               </span></a><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13 20" data-type="monochrome" width="1em"
               height="1em" fill="none" class="separator">
               <path fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" d="M2 2l8 7.9L2 18">
               </path>
            </svg>
            <meta itemprop="position" content="2">
         </li>
         <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem"><span itemprop="name">Thông
               tin cá nhân</span>
      ...
      <div class="g1gd5utk withWidth withGutter c29gcq6"
         ...
         <div class="g1gd5utk swjo00u"
            ...
            <div class="withSpan snf9jyk"
               ...
               <p class="trc72lf">
                  <a href="setting.php" rel="noreferrer"><br><img src="image/canhan.png" width="16" height="16">Thông
                     tin cá nhân</a><br>
            ...
            <div class="withSpan snf9jyk"
               ...
               <div class="l1kr9d9v">
                  <div class="wizard-tab-content">
                     <div role="tabpanel" id="Nộidung0" aria-labelledby="step-Nộidung0" class="wizard-tab-container"
                           ...
                           <div class="grid-column">
                              ...
                              <div data-v-5528d396="" class="form-group form-v4-select-suggest">
                                 ...
                                 <label data-v-5528d396="" for="MXu1QXf7yp" data-limit="2"
                                    ...
                                    style="min-height: 34px; max-height: 50px; height: inherit;">Tòa nhà 3A</label><i
                                    data-v-5528d396="" class="icon-row-slg fa fa-angle-down "></i>
                              </div>
                           </div>
                           <div class="grid-column grid-column-4 grid-xm-column-1">
                              <div data-v-2a5ddd9d="" class="form-group">
                                 <!--  -->
                                 <div data-v-2a5ddd9d="" class="input-group"><input data-v-2a5ddd9d="" type="text"
                                       placeholder="Nhập giá" name="price" class="form-control"><span data-v-2a5ddd9d=""
                              ...
                              <div data-v-2a5ddd9d="" class="form-group">
                                 <!-- -->
                                 <input data-v-2a5ddd9d="" type="text" placeholder="Nhập phòng ngủ" name="list_badroom"
                                    class="form-control">
                              </div>
                              <div data-v-2a5ddd9d="" class="form-group">
                                 <!--  -->
                                 <input data-v-2a5ddd9d="" type="text" placeholder="Nhập phòng tắm" name="list_toilet"
                                    class="form-control">
                              </div>
                           </div>
                        </div>
                     ...
                     <div role="tabpanel" id="Liênhệ1" aria-labelledby="step-Liênhệ1" class="wizard-tab-container"
                        ...
                        <div>
                           <h2>
                              <div class="ten">Thông tin loại phòng</div>
                           </h2>
                           <div class="grid-column">
                              <div data-v-5d159d94="" class="form-group">
                                 ...
                                 <table class="table table-bordered">
                                    <?php
                                    $sql_loaiphong = "SELECT * FROM loaiphong as lp, coloaiphong as clp, khutro as kt, giathuephong as gia where lp.ID_LP = clp.ID_LP and kt.ID_KHUTRO = clp.ID_KHUTRO and gia.ID_LP = lp.ID_LP and gia.ID_KHUTRO = kt.ID_KHUTRO and clp.ID_KHUTRO = $value[ID_KHUTRO] ORDER BY lp.ID_LP DESC ";
                                    ...
                                    while ($row = mysqli_fetch_array($query_loaiphong)) {
                                       ...
                                       <tbody>
                                          <tr>
                                             <!-- <td><?php //echo $row['TENKHUTRO'] ?></td> -->
                                             <td>
                                                <?php echo $row['TENLOAIPHONG'] ?>
                                             </td>
                                             <td>
                                                <?php echo $row['SONGUOIOTOIDA'] ?>
                                             </td>
                                             <td>
                                             ...
                                             <td><a href="sualoaiphong.php?ID_LP=<?php echo $row['ID_LP'] ?>">Sửa</a> | <a
                                                   href="xoaloaiphong.php?ID_LP=<?php echo $row['ID_LP'] ?>">Xóa</a></td>
                                          </tr>
                                       </tbody>
                                       <?php
                                    }
                                       ...
                                       <div class="swjo00u"
                                          ...
                                          <div class="snf9jyk"
                                             ...
                                             <a class="b1ek51v5 accent r-normal large w-normal i-left stretch"
                                                name="submit" id="submit" href="themloaiphong.php"> THÊM LOẠI PHÒNG</a>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
