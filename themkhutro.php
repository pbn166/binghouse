...
<head>
  ...
  <link href="css/themkhutro.css" rel="stylesheet" type="text/css" media="all" />
...
<body class="hero-anime">
          ...
          <nav class="navbar navbar-expand-md navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto py-4 py-md-0">
                ...
                <li class="nav-item pl-4 pl-md-2 ml-0 ml-md-4">
                  <svg xmlns="http://www.w3.org/2000/svg" data-type="monochrome" viewBox="0 0 15.706 19.271" width="1em"
                    height="1em" fill="none" class="aw__ixo30vg">
                    <path
  ...
  <div class="ssn_pw_filter"><br><br>
    <h1 class="font maua">THÊM KHU TRỌ</h1>
    <section class="thue-chothue">
      <a class="hove" href="post.php">
        <div class="chutro">
          <div class="icon-chu">
            <img class="ig" src="image/www.png" width="130px" alt="">
          </div>
          <div class="text-chu">
            <h2 class="maua font">Bạn đã có khu trọ</h2>
            <p class="mauchu">Đến website khu trọ đăng tin</p>
          </div>
        </div>
      </a>
      <a href="themtro.php">
        <div class="khachthue">
          <div class="icon-chu">
            <img src="image/w.png" width="100px" alt="">
          </div>
          <div class="text-chu">
            <h2 class="mau font">Bạn chưa có khu trọ</h2>
            <p class="mauchu">Đến website tạo khu trọ cho bạn</p>
          </div>
        </div>
      </a>
    </section>
  ...
  <div style="width:100%">
    <div class="image">
      <ul class="chuyenanh">
        <li>
          <img style="margin-top: 100px; width: 100%; " src="/image/bg-home-v3.jpg" alt="">
        </li>
        <li>
          <img style="margin-top: 100px; width: 100%;" src="/image/bg.jpg" alt="">
        </li>
      </ul>
    </div>
  </div>
