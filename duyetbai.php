            ...
            <div class="table_container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <table id="dashboard_listing_table" class="dashboard_listing_table table _table-striped" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>ID  Bài viết</th>
                                    <th>Tên nhà trọ</th>
                                    <th>Tiêu đề</th>
                                    <th>Ảnh</th>
                                    <th data-sort="price" class="">Giá <i class="fa"></i></th>
                                    <th data-sort="created" class="active asc">Giới thiệu bài viết<i class="fa"></i></th>
                                    <th style="text-align: center;">Trạng thái</th>
                                    <tr>
                                        <th>01</th>
                                        <th>Nhà trọ Bảy Bảnh</th>
                                        <th>Cho thuê phòng</th>
                                        <th><img src="ha_phong/phong-tro-co-gac-1.jpg" width="100px"></th>
                                        <th>1200000</th>
                                    ...
                                    <th>
                                        ...
                                        <script language="javascript">
                                            ...
                                            button.onclick = function(){
                                                alert("Bạn muốn xóa bài đăng này?");
                                            }
        ...
        <div class="clearfix" style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #35405a;" align="center">
            <div class="company-info">
                <p style="font-size: 1rem;" class="company_name">
                    <strong>| BINGHOUSE.VN</strong>
                </p>
                <p>
                    <strong>Tổng đài CSKH: 0909 999 999</strong>
                </p>
                <p>Email: binghouse@gmail.com</p>
                <p>© Copyright 2023 binghouse.vn</p>
                <p>Địa chỉ: Nguyễn Văn Linh, Ninh Kiều, Thành phố Cần Thơ</p>
                <p></p>
            </div>
