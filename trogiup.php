...
<div class="ssn_pw_filter" >
  <section class="thue-chothue" >
    <a class="hove" href="trogiup-chutro.php">
      <div class="chutro">
        <div class="icon-chu" >
        <img src="https://trogiup.chotot.com/wp-content/themes/chototnew/assets/img/nguoi ban.svg" alt="">
        </div>
        <div class="text-chu">
          <h2>Tôi là người cho thuê</h2>
          <p>Những mẹo vặt và cách đăng tin nhanh chống và tiện lợi trên website</p>
        </div>
      </div>
    </a>
    <a href="nguoithue.php">
      <div class="khachthue">
        ...
        <div class="text-chu">
          ...
          <p>Những mẹo vặt giúp tìm trọ nhanh chống và hiệu quả trên website</p>
        </div>
      </div>
    </a>
  </section>
