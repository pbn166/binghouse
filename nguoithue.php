...
<body class="hero-anime">
          ...
          <nav class="navbar navbar-expand-md navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto py-4 py-md-0">
                ...
                <li class="nav-item pl-4 pl-md-2 ml-0 ml-md-4">
                  <svg xmlns="http://www.w3.org/2000/svg" data-type="monochrome" viewBox="0 0 26.272 24.4" width="1em"
                    height="1em" fill="none" class="aw__i1xnxzjm">
                    <g fill="currentColor">
                      <path
                  ...
                  <svg data-toggle="dropdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em"
                    height="1em" fill="none" class="aw__d1xmuhl0" id="arrowDownB">
                    <path
                ...
                <li class="nav-item pl-4 pl-md-2 ml-0 ml-md-4">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                    class="aw__i1t7n4kh aw__i1t7n4kh--active">
                  ...
                  <div class="dropdown-menu">
                    <div class="aw__m12exo7"><a href="login.php" rel="nofollow"><span class="aw__mdmk8my"></span><span
                          class="aw__meaxp5j">Đăng nhập / Đăng ký</span>
                      </a>
                      <div class="aw__m1pkalbk"><span class="aw__m9yyskr"></span></div>
                      <div class="aw__c1n389kw"></div>
                    </div>
  ...
  <article class="the-article">
    <div class="article-main-content">
      <h2><i class="fas fa-file"></i><strong> HƯỚNG DẪN NGƯỜI THUÊ</strong></h2>
      <hr>
      <p><i class="material-icons">attachment</i> Khi thuê phòng các bạn đọc kỹ mô tả, nội dung tin đăng, đặc biệt là
        mục Giá và Diện tích phù hợp với yêu cầu của bạn hay không.</p>
      ...
      <p>&nbsp;&nbsp;&nbsp; &#187; Các bạn truy cập vào trang chủ BingHouse, trên thanh công cụ bấm chọn "Địa điểm" chọn
        Tỉnh/Thành. Hệ thống sẽ trả về thông tin các phòng trọ ở tỉnh thành bạn tìm kiếm.
        Nếu muốn thu hẹp tìm trọ ở một "Xã, Quận, Huyện" hay "Vị Trí" cụ thể ở một tỉnh thành. Ví dụ vào ô "Địa điểm"
        bấm chọn Tỉnh Cần Thơ, tiếp tục vào ô "Quận/huyện" để chọn Quận Ninh Kiều thì hệ thống sẽ trả về kết quả những
        trọ trong khu vực quận Ninh Kiều. Tương tự với Vị trí. </p>
      <p><i class="fas fa-heart"></i> Bước 2: Tìm kiếm theo loại hình phòng trọ</p>
      <p>&nbsp;&nbsp;&nbsp; &#187; Sau khi chọn Tỉnh Thành, Quận (huyện), Đường phố và Vị trí thì các bạn sẽ tiếp tục
        thao tác trên trên thanh công cụ. Bấm chọn vào ô "Chọn loại phòng" => Tùy vào nhu cầu bạn có thể bấm chọn "Phòng
        trọ - Phòng đơn - Phòng đôi - Phòng gia đình - ở ghép,..." để chọn loại hình phòng trọ. Hệ thống sẽ trả về thông
        tin loại hình phòng trọ mà bạn cần tìm kiếm. </p>
      <p><i class="fas fa-heart"></i> Bước 3: Tìm phòng trọ theo giá thành và các tiêu chí khác</p>
      <p>&nbsp;&nbsp;&nbsp; &#187; Tương tự như cách tìm trọ đã hướng dẫn trên, dựa vào nhu cầu và điều kiện của bạn có
        thể thuê, các bạn có thể tiếp tục thao tác trên thanh công cụ để tìm chọn phòng trọ có giá thành và tiện nghi
        phù hợp.</p>
