                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingOne">
                             ...
                             Danh Sách Các Khu Trọ Trên Địa Bàn Thành Phố Cần Thơ
                            </button>
                            </h2>
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <ul class="list-group list-group-flush" id="lstMotel">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <ul class="list-group list-group-flush" id="lstUnv">
                                     <li class ="list-group-item 1">And a fifth</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
getDataToHtml(null, 'lstMotel', 'TENKHUTRO');
...
function getDataToHtml1(data, elmParentId, fieldVisible) {
  var content = "";
  var elm = document.getElementById(elmParentId);
  if (elm) {
    <?php foreach ($mapsql1 as $key => $value){?>
      var name = <?php echo json_encode($value['T_TENTRUONG']); ?>;
      var lat = <?php echo json_encode($value['LAT_TRUONG']); ?>;
      var lng = <?php echo json_encode($value['LONG_TRUONG']); ?>;
      content += '<li class="list-group-item 1" onclick="flyToSchool(' + lat + ', ' + lng + ')">' + name + '</li>';
    <?php } ?>
    elm.innerHTML = content;
  }
}
...
getDataToHtml1(null, 'lstUnv', 'T_TENTRUONG');
function flyToSchool(lat, lng) {
  map.flyTo({
    center: [lng, lat],
    zoom: 16,
