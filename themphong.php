...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Saira+Semi+Condensed:wght@200&amp;family=Satisfy&amp;display=swap"
        rel="stylesheet">
...
<body class="">
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto py-4 py-md-0">
                                ...
                                <li class="nav-item pl-4 pl-md-2 ml-0 ml-md-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" data-type="monochrome"
                                        viewBox="0 0 15.706 19.271" width="1em" height="1em" fill="none"
                                        class="aw__ixo30vg">
                                        <path
    ...
    <div class="l1tlqmyy">
        <ol class="mx-3 md:mx-0 s1vf7tl0" style="padding-bottom:20px" itemscope=""
            itemtype="https://schema.org/BreadcrumbList">
            <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem"><a href="index.php"
                    itemprop="item"><span itemprop="name">Bing House</span></a><svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 13 20" data-type="monochrome" width="1em" height="1em" fill="none" class="separator">
                    <path fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" d="M2 2l8 7.9L2 18">
                    </path>
                </svg>
                <meta itemprop="position" content="1">
            </li>
            <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem"><a href="setting.php"
                    class="text-blue-500 inline-flex max-w-[150px] md:max-w-none [&amp;>span]:truncate"
                    itemprop="item"><span itemprop="name">Trang cá nhân của
                        <?php echo $_SESSION['TENDANGNHAP']; ?>
                    </span></a><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13 20" data-type="monochrome"
                    width="1em" height="1em" fill="none" class="separator">
                    <path fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" d="M2 2l8 7.9L2 18">
                    </path>
                </svg>
        ...
        <div class="g1gd5utk withWidth withGutter c29gcq6"
            ...
            <div class="g1gd5utk swjo00u"
                ...
                <div class="withSpan snf9jyk"
                    ...
                    <p class="trc72lf">
                        <a href="setting.php" rel="noreferrer"><br><img src="image/canhan.png" width="16"
                                height="16">Thông
                            tin cá nhân</a><br>
                    ...
                    <a href="repassword.php" rel="noreferrer"><img src="image/khoak.png" width="16" height="16">Cài đặt
                        tài
                        khoản</a><br>
                    </p>
                    <span class="f6ete4">
                ...
                <div class="withSpan snf9jyk"
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <div class="l1kr9d9v">
                                    <!-- -->
                                    <div class="withSpan snf9jyk"
                                        style="--snf9jyk-0:initial;--snf9jyk-1:initial;--snf9jyk-2:100%;--snf9jyk-4:initial;--snf9jyk-6:100%;--snf9jyk-8:initial;--snf9jyk-10:100%;--snf9jyk-12:initial;--snf9jyk-14:100%;--snf9jyk-16:initial;--snf9jyk-18:100%;--snf9jyk-20:initial">
                                        <div>
                                            <div>
                                                <div></div>
                                            </div>
                    ...
                    <div class="l1kr9d9v">
                        <div class="wizard-tab-content">
                            <div role="tabpanel" id="Nộidung0" aria-labelledby="step-Nộidung0"
                                class="wizard-tab-container" style="display: none;" aria-hidden="true">
                                <div>
                                    <div class="grid-column">
                                        ...
                                        <div data-v-5528d396="" class="form-group form-v4-select-suggest">
                                            <!--  -->
                                            <label data-v-5528d396="" for="MXu1QXf7yp" data-limit="2"
                                                class="form-control limit-text"
                                                style="min-height: 34px; max-height: 50px; height: inherit;">Tòa nhà
                                                3A</label><i data-v-5528d396=""
                                                class="icon-row-slg fa fa-angle-down "></i>
                                        </div>
                                    </div>
                                    <div class="grid-column grid-column-4 grid-xm-column-1">
                                        <div data-v-2a5ddd9d="" class="form-group">
                                            <!--  -->
                                            <div data-v-2a5ddd9d="" class="input-group"><input data-v-2a5ddd9d=""
                                                    type="text" placeholder="Nhập giá" name="price"
                                                    class="form-control"><span data-v-2a5ddd9d=""
                                                    class="input-group-addon">VNĐ</span></div>

                                        </div>
                                        <div data-v-2a5ddd9d="" class="form-group">
                                            <!-- -->
                                            <div data-v-2a5ddd9d="" class="input-group">
                                                <input data-v-2a5ddd9d="" type="text" placeholder="Nhập diện tích"
                                                    name="list_acreage" class="form-control">
                                                <span data-v-2a5ddd9d="" class="input-group-addon">m<sup>2</sup></span>
                                            </div>

                                        </div>
                                        <div data-v-2a5ddd9d="" class="form-group">
                                            <!-- -->
                                            <input data-v-2a5ddd9d="" type="text" placeholder="Nhập phòng ngủ"
                                                name="list_badroom" class="form-control">
                                        </div>
                                        <div data-v-2a5ddd9d="" class="form-group">
                                            <!--  -->
                                            <input data-v-2a5ddd9d="" type="text" placeholder="Nhập phòng tắm"
                                                name="list_toilet" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div role="tabpanel" id="Liênhệ1" aria-labelledby="step-Liênhệ1"
                                ...
                                <div>
                                    ...
                                    <form action="themphong.php" method="post" enctype="multipart/form-data">
                                        ...
                                        $sql_tt = "SELECT DISTINCT * FROM trangthai";
                                        ...
                                        <div class="row-main">
                                            ...
                                            <div class="grid-column">
                                                <div data-v-5d159d94="" class="form-group">
                                                    <label data-v-5d159d94="" class="label-form">Hình
                                                        <small data-v-5d159d94="" style="color: red;">*</small></label>
                                                    <input data-v-5d159d94="" type="file" placeholder="Tên phòng"
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql_themphong = "INSERT INTO PHONG(TENPHONG, ID_TT, ID_KHUTRO, ID_LP) VALUES('" . $TENPHONG . "', '" . $TRANGTHAI. "', '" . $value['ID_KHUTRO'] . "', '" . $LOAIPHONG . "')";
                    $query_themphong = mysqli_query($conn, $sql_themphong);
                    $sql_stt = "SELECT MAX(STT) FROM PHONG";
                    $query_stt = mysqli_query($conn, $sql_stt);
                    $stt = mysqli_fetch_assoc($query_stt);
                    if ($query_themphong) {
                        if ($stt) {
                            $stt_p = $stt['MAX(STT)'];
                            $sql_themhinh = "INSERT INTO HINH (STT, HINH) VALUES('" . $stt_p . "', '" . $hinhanh . "' )";
                            $query_themhinh = mysqli_query($conn, $sql_themhinh);
