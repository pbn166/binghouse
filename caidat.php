...
<html lang="vi">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="image/home-v1.png"/>
         <link href="css/caidat.css" rel="stylesheet" type="text/css" media="all"/>
  ...
  <div class="container">
    <div class="row">
      ...
      <form action="" method>
        ...
        <input type="text" placeholder="Nhập họ tên" name="Username" id="Username"><br>
        ...
        <input type="text" placeholder="Nhập số điện thoại" name="Phone" id="Phone"><br>
        <label for="name">Tên đăng nhập:</label>
        <input type="text" placeholder="Nhập tên đăng nhập" name="name" id="name"><br>
        <label for="password">Mật khẩu:</label>
        <input type="text" placeholder="Nhập mật khẩu" name="password" id="pw"><br>
        <label for="address">Địa chỉ:</label>
        <input type="text" placeholder="Nhập địa chỉ" name="address" id="address"><br>
        <label for="pr">Giới thiệu:</label>
        <textarea rows="" placeholder="Nhập nội dung giới thiệu" cols="20" maxlenght="25"></textarea><br>
        <input type="submit" name="luuthongtin" value="Cập nhật thông tin">
                      </div>
