...
<body class="hero-anime">
  ...
  <div class="wrapper">
    <div class="left-panel">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Chức năng<i class="fas fa-arrow-left" style="float: right;"
              onclick="closeLeftPanel()"></i></h5>
          <div class="accordion" id="accordionExample">
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                  aria-expanded="true" aria-controls="collapseOne">
                  Danh Sách Các NHÀ TRỌ TRÊN ĐỊA BẢN THÀNH PHỐ CẦN THƠ
                </button>
              </h2>
    ...
    <script>
      ...
      foreach ($mapsql as $key => $value) { ?>
        ...
        var name = <?php echo json_encode($value['TENKHUTRO']); ?>;
        ...
        var marker = new mapboxgl.Marker()
          .setLngLat([<?php echo $value["LONG_TRO"]; ?>, <?php echo $value["LAT_TRO"]; ?>])
          .setPopup(popup)
          .addTo(map);
  ...
  /*var marker = new mapboxgl.Marker({
      ...
      function getDataToHtml(data, elmParentId, fieldVisible) {
        ...
        if (elm) {
          <?php foreach ($mapsql as $key => $value) { ?>
            var name = <?php echo json_encode($value['TENKHUTRO']); ?>;
            var lat = <?php echo json_encode($value['LAT_TRO']); ?>;
            var lng = <?php echo json_encode($value['LONG_TRO']); ?>;
      ...
      getDataToHtml(null, 'lstUnv', 'TENKHUTRO');
